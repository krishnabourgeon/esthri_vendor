class PendingDatamodel {
  ...
  PendingDatamodel({this.status, this.orders, this.message});
...
class Orders {
  ...
  String? dropoffDate;
  PickupTimeSlot? dropoffTimeSlot;
  String? customerName;
  int? customerId;
  ...
  Orders.fromJson(Map<String, dynamic> json) {
    ...
    pickupTimeSlot = json['pickup_time_slot'] != null
        ? new PickupTimeSlot.fromJson(json['pickup_time_slot'])
        : null;
    dropoffDate = json['dropoff_date'];
    dropoffTimeSlot = json['dropoff_time_slot'] != null
        ? new PickupTimeSlot.fromJson(json['dropoff_time_slot'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pickupTimeSlot != null) {
      data['pickup_time_slot'] = this.pickupTimeSlot!.toJson();
    }
    data['dropoff_date'] = this.dropoffDate;
    if (this.dropoffTimeSlot != null) {
      data['dropoff_time_slot'] = this.dropoffTimeSlot!.toJson();
    }
...
class PickupTimeSlot {
  ...
  PickupTimeSlot({this.id, this.startTime, this.endTime});
